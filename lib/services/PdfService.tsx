...
const styles = StyleSheet.create({
    ...
    header: { marginBottom: 20, borderBottom: 1, paddingBottom: 10, borderBottomColor: '#ccc' },
    title: { fontSize: 24, marginBottom: 5, color: '#1a365d' }, // Navy Blue
    ...
    <Document>
        <Page size="A4" style={styles.page}>
            <View style={styles.header}>
                ...
                <Text style={styles.subtitle}>Capital Crew Sacco • Application #{loan.loanApplicationNumber}</Text>
            </View>
            ...
            <View style={styles.section}>
                ...
                <View style={styles.row}>
                    ...
                    <Text style={styles.value}>{member.externalId || 'N/A'}</Text>
                </View>
            </View>
            ...
            <View style={styles.footer}>
                <Text>Generated by Capital Crew Sacco System • {new Date().toLocaleString()}</Text>
            </View>
        </Page>
    </Document>
)
